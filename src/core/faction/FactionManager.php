...
class FactionManager {
    ...
    public function init(): void {
        ...
        while($stmt->fetch()) {
            ...
            if($x !== null and $y !== null and $z !== null) {
                $home = new Position($x, $y, $z, Mythical::getInstance()->getServer()->getLevelByName(Faction::CLAIM_WORLD));
            }
    ...
    public function createFaction(string $name, CrypticPlayer $leader): void {
        ...
        $stmt = Mythical::getInstance()->getMySQLProvider()->getDatabase()->prepare("INSERT INTO factions(name, members) VALUES(?, ?)");
