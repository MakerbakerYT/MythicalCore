    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): void {
        ...
        switch($args[1]) {
            ...
            case 2:
                ...
                $sender->sendMessage(TextFormat::YELLOW . " /faction home " . TextFormat::GOLD . "- " . TextFormat::GRAY . "Teleport to your faction home.");
            ...
            case 4:
                ...
                $sender->sendMessage(TextFormat::YELLOW . " /faction map " . TextFormat::GOLD . "- " . TextFormat::GRAY . "Open faction map.");
                $sender->sendMessage(TextFormat::YELLOW . " /faction overclaim " . TextFormat::GOLD . "- " . TextFormat::GRAY . "Override a claim.");
