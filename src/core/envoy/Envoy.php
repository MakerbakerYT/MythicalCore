...
class Envoy {
     ...
     *
     */
    public function claim(MythicalPlayer $player): void {
        $rewards = Mythical::getInstance()->getEnvoyManager()->getRewards();
    ...
    public function despawn(): void {
        ...
        Mythical::getInstance()->getEnvoyManager()->despawnEnvoy($this->position);
    }
}
