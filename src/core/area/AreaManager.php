...
class AreaManager {
    ...
    public function init(): void {
        $this->addArea(new Area("Spawn", new Position(-1000, 100, -1000, $this->core->getServer()->getDefaultLevel()), new Position(1000, 256, 1000, $this->core->getServer()->getDefaultLevel()), false, false));
