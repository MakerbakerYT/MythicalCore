...
class TradeSession {
     ...
     *
     * @param MythicalPlayer $sender
     * @param MythicalPlayer $receiver
     */
    public function __construct(CrypticPlayer $sender, MythicalPlayer $receiver) {
        $this->sender = $sender;
        ...
        $this->menu->setInventoryCloseListener(
            function(Player $player, Inventory $inventory): void {
                ...
                Mythical::getInstance()->getTradeManager()->removeSession($this->key);
            }
        );
    }
     ...
     */
    public function getSender(): MythicalPlayer {
        return $this->sender;
    }
     ...
     * @return CrypticPlayer
     */
    public function getReceiver(): MythicalPlayer {
