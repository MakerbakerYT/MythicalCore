...
class CombatManager {
     ...
     * @return int
     */
    public function getGodAppleCooldown(MythicalPlayer $player): int {
        $cd = 0;
     ...
     * @return int
     */
    public function getGoldenAppleCooldown(MythicalPlayer $player): int {
        $cd = 0;
     ...
     * @return int
     */
    public function getEnderPearlCooldown(MythicalPlayer $player): int {
        $cd = 0;
