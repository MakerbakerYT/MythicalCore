...
class CorruptedKing extends Boss {
    ...
    public function __construct(Level $level, CompoundTag $nbt) {
        $path = Mythical::getInstance()->getDataFolder() . "skins" . DIRECTORY_SEPARATOR . "corruptedKing.png";
    ...
    public function onDeath(): void {
        ...
        Server::getInstance()->broadcastMessage($p->getDisplayName() . TextFormat::GRAY . " has dealt the most damage " . TextFormat::DARK_GRAY . "(" . TextFormat::WHITE . $d . TextFormat::RED . TextFormat::BOLD . " DMG" . TextFormat::RESET . TextFormat::DARK_GRAY . ")" . TextFormat::GRAY . " to " . TextFormat::BOLD . TextFormat::YELLOW . "Corrupted King " . TextFormat::RESET . TextFormat::GRAY . "and received:");
