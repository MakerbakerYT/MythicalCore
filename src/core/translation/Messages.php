...
interface Messages {
    ...
    const MESSAGE = [
        ...
        "voteBroadcast" => self::AQUA . "{name} has voted for our server at vote.mythicalnetwork.net and received a reward! {votes} votes before everyone receiving {amount} sacred stones! Amount of total sacred stones given increases as the goal is achieved.",
