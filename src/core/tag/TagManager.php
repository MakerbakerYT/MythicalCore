...
class TagManager{
    ...
    public function __construct(){
        Server::getInstance()->getPluginManager()->registerEvents(new TagListener($this), Mythical::getInstance());
     ...
     * @return string|null
     */
    public function getTag(MythicalPlayer $player, bool $format = false): ?string{
     ...
     * @return array|null
     */
    public function getTagList(MythicalPlayer $player): ?array{
        $tags = $player->getTags();
     ...
     * @return bool
     */
    public function giveTag(MythicalPlayer $player, string $tag): bool{
     ...
     * @param string        $tag
     */
    public function removeTag(MythicalPlayer $player, string $tag): void{
        if(!isset($this->tags[$tag])){
            $player->sendMessage("§l§8(§c!§8)§r §7Tag doesn't exist, ($tag).");
            return;
        }
     ...
     * @return bool
     */
    public function setTag(MythicalPlayer $player, string $tag): bool{
        if(!isset($this->tags[$tag])){
     ...
     */
    public function setForceTag(MythicalPlayer $player, ?string $tag): void{
