...
class EntityManager {
	...
	BlockFactory::registerBlock extends Bedrock {
        ...
        $path = Mythical::getInstance()->getDataFolder() . "skins" . DIRECTORY_SEPARATOR . "merchant.png";
        ...
        $path = Mythical::getInstance()->getDataFolder() . "skins" . DIRECTORY_SEPARATOR . "astronaut.png";
        ...
        $path = Mythical::getInstance()->getDataFolder() . "skins" . DIRECTORY_SEPARATOR . "updater.png";
        ...
        $path = Mythical::getInstance()->getDataFolder() . "skins" . DIRECTORY_SEPARATOR . "alchemist.png";
