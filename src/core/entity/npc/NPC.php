...
class NPC {
     ...
     * @param CrypticPlayer $player
     */
    public function despawnFrom(MythicalPlayer $player): void {
     ...
     * @param CrypticPlayer $player
     */
    public function move(MythicalPlayer $player): void {
        $xdiff = $player->x - $this->position->x;
        $zdiff = $player->z - $this->position->z;
        $angle = atan2($zdiff, $xdiff);
        $yaw = (($angle * 180) / M_PI) - 90;
     ...
     * @param CrypticPlayer $player
     */
    public function setNameTag(MythicalPlayer $player): void {
