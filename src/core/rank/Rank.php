...
class Rank {
     ...
     * @return string
     */
    public function getChatFormatFor(MythicalPlayer $player, string $message, array $args = []): string {
        $man = Mythical::getInstance()->getTagManager();
     ...
     * @return string
     */
    public function getTagFormatFor(MythicalPlayer $player, array $args = []): string {
