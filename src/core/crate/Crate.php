...
abstract class Crate {
     ...
     */
    abstract public function spawnTo(MythicalPlayer $player): void;

    /**
     * @param CrypticPlayer $player
     */
    abstract public function updateTo(MythicalPlayer $player): void;

    /**
     * @param CrypticPlayer $player
     */
    abstract public function despawnTo(MythicalPlayer $player): void;

    /**
     * @param Reward        $reward
     * @param CrypticPlayer $player
     */
    abstract public function showReward(Reward $reward, MythicalPlayer $player): void;
     ...
     */
    public function try(MythicalPlayer $player): void {
