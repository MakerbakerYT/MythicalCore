...
class RareCrate extends Crate {
    ...
    public function __construct(Position $position) {
        parent::__construct(self::RARE, $position, [
            new Reward("$5,000", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("3,000 XP Note", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem((new XPNote(3000))->getItemForm());
            }, 100),
            new Reward("x32 Obsidian", Item::get(Item::OBSIDIAN, 0, 32), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem(Item::get(Item::OBSIDIAN, 0, 32));
            }, 85),
            new Reward("x5 Enchanted Golden Apple", Item::get(Item::ENCHANTED_GOLDEN_APPLE, 0, 5), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem(Item::get(Item::ENCHANTED_GOLDEN_APPLE, 0, 5));
            }, 79),
            new Reward("x32 Golden Apple", Item::get(Item::GOLDEN_APPLE, 0, 32), function(MythicalPlayer $player): void {
            ...
            new Reward("King Kit", Item::get(Item::CHEST_MINECART, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("x32 TNT", Item::get(Item::TNT, 0, 32), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem(Item::get(Item::TNT, 0, 32));
            }, 91),
            new Reward("Sell Wand (Uses: 10)", Item::get(Item::DIAMOND_HOE, 0, 1), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem((new SellWand(10))->getItemForm());
            }, 90),
            new Reward("x10 Bedrock", Item::get(Item::BEDROCK, 0, 10), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem(Item::get(Item::BEDROCK, 0, 10));
            }, 91),
            new Reward("x2 Epic Crate Keys", Item::get(Item::STRING), function(MythicalPlayer $player): void {
