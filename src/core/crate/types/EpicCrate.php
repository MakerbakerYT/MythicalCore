...
class EpicCrate extends Crate {
    ...
    public function __construct(Position $position) {
        parent::__construct(self::EPIC, $position, [
            new Reward("$10,000", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
                $player->addToBalance(10000);
            }, 50),
            new Reward("$20,000", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("5,000 XP Note", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem((new XPNote(5000))->getItemForm());
            }, 100),
            new Reward("Blaze Spawner", Item::get(Item::MOB_HEAD_BLOCK, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("God Kit", Item::get(Item::CHEST_MINECART, 0, 1), function(MythicalPlayer $player): void {
                $item = new ChestKit(Cryptic::getInstance()->getKitManager()->getKitByName("God"));
                $player->getInventory()->addItem($item->getItemForm());
            }, 85),
            new Reward("Cryptic Kit", Item::get(Item::CHEST_MINECART, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("Sell Wand (Uses: 25)", Item::get(Item::DIAMOND_HOE, 0, 1), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem((new SellWand(25))->getItemForm());
            }, 90),
            new Reward("x32 Bedrock", Item::get(Item::BEDROCK, 0, 32), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem(Item::get(Item::BEDROCK, 0, 32));
            }, 87),
            new Reward("x2 Legendary Crate Keys", Item::get(Item::PAPER), function(MythicalPlayer $player): void {
