...
class VoteCrate extends Crate {
    ...
    public function __construct(Position $position) {
        parent::__construct(self::VOTE, $position, [
            new Reward("$1,000", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
                $player->addToBalance(1000);
            }, 50),
            new Reward("$2,500", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("1,000 XP Note", Item::get(Item::PAPER, 0, 1), function(MythicalPlayer $player): void {
                $player->getInventory()->addItem((new XPNote(1000))->getItemForm());
            }, 100),
            new Reward("Pig Spawner", Item::get(Item::MOB_SPAWNER, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("Knight Kit", Item::get(Item::CHEST_MINECART, 0, 1), function(MythicalPlayer $player): void {
                $item = new ChestKit(Cryptic::getInstance()->getKitManager()->getKitByName("Knight"));
                $player->getInventory()->addItem($item->getItemForm());
            }, 100),
            new Reward("Mystic Kit", Item::get(Item::CHEST_MINECART, 0, 1), function(MythicalPlayer $player): void {
            ...
            new Reward("x2 Common Crate Keys", Item::get(Item::STRING), function(MythicalPlayer $player): void {
