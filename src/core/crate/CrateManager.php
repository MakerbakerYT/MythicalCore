...
class CrateManager {
    ...
    public function init() {
        ...
        $this->addCrate(new CommonCrate(new Position(225, 100, 283, $level)));
        $this->addCrate(new LegendaryCrate(new Position(233, 100, 278, $level)));
        $this->addCrate(new TagCrate(new Position(241, 73, 100, $level)));
        $this->addCrate(new EpicCrate(new Position(249, 100, 270, $level)));
        $this->addCrate(new RareCrate(new Position(258, 100, 268, $level)));
        $this->addCrate(new VoteCrate(new Position(217, 100, 289, $level)));
    }
