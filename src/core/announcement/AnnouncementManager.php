...
class AnnouncementManager {
    ...
    public function init(): void {
       $this->messages = [
            "\n§l§b » §r§7Follow our server Twitter to stay updated! §l§bTwitter: @Mythical Network§r§7.§r\n",
            "\n§l§b » §r§7Purchase ranks, perks and others at our store. Our store is located at §l§bstore:COming Soon§r§7.§r\n",
            "\n§l§b » §r§7Vote for our server, once you have voted, type §l§b/vote§r §7to receive rewards! §l§bVote at: vote:Coming Soon§r§7.§r\n",
            ...
            "\n§l§b » §r§7Need to know the server IP and PORT? §l§bIP: Coming Soon§r §7| §l§bPORT: 19132§r§7.\n",
            "\n§l§b » §r§7Please invite your §l§bfriends§r §7to §l§bplay§r §7on our server!§r\n",
            "\n§l§b » §r§7Chat with our community, report issues and view updates on our Discord server. Join our Discord server now! §l§bDiscord: Coming Soon§r§7.§r\n",
       ];
    }
