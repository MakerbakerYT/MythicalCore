...
class MaskManager{
    ...
    public function __construct(){
        Server::getInstance()->getPluginManager()->registerEvents(new MaskListener(), Mythical::getInstance());
        Mythical::getInstance()->getScheduler()->scheduleRepeatingTask(new MaskTask($this), 60);
