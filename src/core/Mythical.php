...
class Mythical extends PluginBase {
    ...
    private static $SERVER_NAME = "§l§6Mythical§eNetwork§r §7- §l§b Op Factions§r§7";

    const MESSAGES = [
        "§l§6Mythical§eNetwork§r §7- §l§bSERVER RESET!§r§7",
        "§l§6Mythical§eNetworl§r §7- §l§bSERVER RELEASED!§r§7",
        "§l§6Mythical§eNetwork§r §7- §l§bSEASON I§r§7",
    ];
    ...
    function initEvents(): void {
        $this->getServer()->getPluginManager()->registerEvents(new MythicalListener($this), $this);
