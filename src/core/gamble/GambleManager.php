...
class GambleManager {
     ...
     * @param int           $amount
     */
    public function addCoinFlip(MythicalPlayer $player, int $amount): void {
     ...
     * @param CrypticPlayer $player
     */
    public function removeCoinFlip(MythicalPlayer $player): void {
        if(!isset($this->coinFlips[$player->getName()])) {
            return;
        }
     ...
     * @param $losses
     */
    public function getRecord(MythicalPlayer $player, &$wins, &$losses): void {
     ...
     * @param CrypticPlayer $player
     */
    public function createRecord(MythicalPlayer $player): void {
     ...
     * @param CrypticPlayer $player
     */
    public function addWin(MythicalPlayer $player): void {
     ...
     * @param CrypticPlayer $player
     */
    public function addLoss(MythicalPlayer $player): void {
        $record = $this->coinFlipRecord[$player->getName()];
        $reward = explode(":", $record);
        $wins = $reward[0];
        $losses = $reward[1] + 1;
